...
// Import images
import facebookIcon from './1384005.png';
import instagramIcon from './1384015.png';
import twitterIcon from './1384017.png';
import youtubeIcon from './1384012.png';
import linkedinIcon from './1384007.png';
...
We recognize that everyone's lifestyle and fitness needs are different. That's why we offer a variety of membership options to suit your individual preferences and schedule. Whether you prefer a short-term commitment or a long-term plan, we have flexible memberships that provide access to our extensive facilities and services, making it easier for you to stay consistent and achieve your fitness goals.</p>
  ...
  <h2>Our Legacy</h2>
  <ul>
    <li><strong>Founded in 2000:</strong> Peak Performance Gym has established itself as a leader in fitness and wellness, becoming a trusted name in the community.</li>
  ...
  <div className="footer-content">
    ...
    <div className="footer-contact">
      <h2>Contact Us</h2>
      <p>Email: info@peakperformancegym.com</p>
      <p>Phone: +123 456 7890</p>
      <p>Address: 123 Fitness Lane, Muscle City, USA</p>
    </div>
  ...
  <div className="footer-bottom">
    <p>&copy; 2024 Peak Performance Gym. All rights reserved.</p>
  </div>
</footer>
